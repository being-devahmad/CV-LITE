      ...
      <div className="w-full max-w-7xl mx-auto px-4 py-12">
        <div className="flex flex-col md:flex-row items-start justify-between gap-12">
          <div className="flex-1 space-y-6">
            <h2 className="text-[0.5em] font-semibold text-gray-900">
              Why are cover letters needed?
            </h2>

            <div className="space-y-[2vh] text-gray-600 ">
              <p className="text-[0.35em]">
                ...
                attached to, or accompanying another document such as a résumé
              ...
              <p className="text-[0.35em]">
                ...
                their suitability for the desired positions. Employers may look
                for individualized and thoughtfully written cover letters as one
                method of screening out applicants who are not sufficiently
                interested in their positions or who lack necessary basic
                skills.
              </p>
              <div className="text-[1em]" onClick={handleCreateCoverLetter}>
                <Button text={"Create New"} icon />
              </div>
            </div>
          </div>
