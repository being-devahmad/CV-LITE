...
export function ResumeTemplates() {
  ...
  return (
    <div className="space-y-6 text-[7vw] md:text-[4vw] lg:text-[3vw]">
      <h1 className="text-[0.7em] font-bold ">Your Resumes</h1>
      {resumes.length === 0 ? (
        <Card>
          <CardContent className="pt-6">
            <p className="text-center text-muted-foreground text-[0.5em] p-[1em] text-gray-800">
