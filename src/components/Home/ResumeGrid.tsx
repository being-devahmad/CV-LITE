      ...
      <div className="grid lg:grid-cols-2 gap-10 max-w-7xl w-full mx-auto">
        ...
        <div className="space-y-6">
          <h1 className="text-3xl md:text-4xl font-bold text-[#151B23] leading-snug">
            <span className="text-platformGreen">Stand out</span> from the
            competition and secure your dream job with a professionally designed
            CV.
          </h1>
          ...
          <button className="bg-platformGreen text-white px-6 py-3 rounded-2xl shadow hover:scale-110 transition-colors duration-300">
