    ...
    <section className="mb-8">
      ...
      <div className="flex flex-col gap-4 mb-2">
        {education.map((educationVal, index) => {
          const { degree, startDate, endDate, organization, location } =
            educationVal;
          return (
            <div key={index}>
    ...
    <section className="mb-8">
      ...
      <div className="space-y-6">
        {experiences.map((experienceVal) => {
          const { company, startDate, endDate, title, location, description } =
            experienceVal;
          return (
            <div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                ...
                <div className="flex gap-0.5 items-center">
                  ...
                  <p className="text-sm">
                    {" "}
                    {startDate} -{" "}
                    {endDate ? endDate : !endDate && current && "present"}
                  </p>
                </div>
              </div>
...
const Skills = ({
  ...
  allData: { skills: Array<{ name: string; level: string }> };
}) => {
...
const Languages = ({
  ...
  allData: { languages: { name: string; level: string }[] };
}) => {
